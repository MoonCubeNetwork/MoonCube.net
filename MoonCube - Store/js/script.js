...
document.addEventListener('DOMContentLoaded', () => {
    const filterButtons = document.querySelectorAll('.filter-btn');
    const skinCategories = document.querySelectorAll('.skin-category');

    skinCategories.forEach(category => {
        if (category.id === 'hats' || category.id === 'swords' || category.id === 'hoes' || category.id === 'shovels' || category.id === 'axes' || category.id === 'pickaxes') {
    ...
    filterButtons.forEach(button => {
        button.addEventListener('click', () => {
            ...
            skinCategories.forEach(categoryElement => {
                if (category === 'all' || categoryElement.id === category) {
